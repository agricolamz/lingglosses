...
I also wanted to mention paper by [@round20], where authors provided script for the automated identification and parsing of interlinear glossed text from scanned page images (see their [script](https://github.com/erichround/LREC_IGT/)).
