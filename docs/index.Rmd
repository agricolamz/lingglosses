...
In the third section I show how to create a semi-automatic compiled abbreviation list for your document. As an example I provide the abbreviation list for this exact document. Even though the `r add_gloss("FUT")` and  `r add_gloss("MSD")` gloss appears only in this exact section in the table above, it appears in the gloss lists presented in the third section.
