...
In order to make everything work you need to put an `add_audio_js_script()` command somewhere in the document. It simply adds JavaScript code for audio player to your `rmarkdown` document.
