...
It is possible to add a sound to the example using an `audio_path` argument.
...
In order to make everything work you need to put a `add_js_script_for_audio()` command somewhere in the document. It simply adds JavaScript code for audio player to your `rmarkdown` document.
